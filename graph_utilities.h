...
namespace mcqsgraphutils {
	...
	Graph ConnectTwoGraphsWithEdge(const Graph& g, const typename Graph::vertex_descriptor connect_from,
		const Graph& j, const typename Graph::vertex_descriptor connect_to,
	...
	*/
	...
	template<class Graph, class CollectionType1, class CollectionType2>
	std::pair<Graph, typename Graph::vertex_descriptor>
	...
	/*
	template<class Graph> void EndDepthFirstSearch(const Graph& g, const typename Graph::vertex_descriptor v,
		std::list<typename Graph::vertex_descriptor>& all_vertecies_in_current_path,
		std::vector<std::list<typename Graph::vertex_descriptor>>& all_path) {
	...
	template<class Graph> std::span<std::vector<std::list<typename Graph::vertex_descriptor>>> AllPath(const Graph& g) {
